...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                <form method="POST" action="{{ route('backend.slide.update', $slide->id) }}" class="form-horizontal form-bordered" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Edit Slide</h2>
                    </header>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <br>
                                <img src="{{ asset('storage/'.$slide->profileImage) }}" alt="" class="img-responsive">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" id="description" name="description" rows="3" required>{{ old('description', $slide->description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="link" name="link" value="{{ old('link', $slide->link) }}" required>
                            </div>
                        </div>
                    </div>
